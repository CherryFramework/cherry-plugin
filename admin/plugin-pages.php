...
//Main plugin page
	if( !function_exists('cherry_plugin_main_page') ){
		function cherry_plugin_main_page(){
			get_cherry_plugin_header(array('title' => __('Cherry Plugin', CHERRY_PLUGIN_DOMAIN), 'icon_class' => 'icon-generic'));
...
//import settings page
	if( !function_exists('cherry_plugin_import_page') ){
		function cherry_plugin_import_page(){
			get_cherry_plugin_header(array('title' => __('Cherry Import', CHERRY_PLUGIN_DOMAIN), 'icon_class' => 'icon-generic'));
...
//export settings page
	if( !function_exists('cherry_plugin_export_page') ){
		function cherry_plugin_export_page(){
			get_cherry_plugin_header(array('title' => __('Cherry Export', CHERRY_PLUGIN_DOMAIN), 'icon_class' => 'icon-generic'));
