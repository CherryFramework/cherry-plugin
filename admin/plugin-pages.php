			...
			<div class="cols cols-2">
				<div class="col">
					<div class="plugin-option">
						...
						<h4><a href="http://info.template-help.com/help/quick-start-guide/wordpress-themes/master/index_en.html#shortcodes"><?php _e('Shortcodes', CHERRY_PLUGIN_DOMAIN); ?></a></h4>
						<p>Cherry Plugin adds various widgets to the post editor toolbar. Shortcodes allow to create various content structures without using complex coding layouts or additional tools. </p>
					</div>
				</div>
				<div class="col">
					<div class="plugin-option">
						...
						<h4><a href="http://info.template-help.com/help/quick-start-guide/wordpress-themes/master/index_en.html#plugins_widgets"><?php _e('Widgets', CHERRY_PLUGIN_DOMAIN); ?></a></h4>
						<p>Cherry Widgets offer additional ways to place content to widget areas. Several available widget will allow you to add more functionality to your website.</p>
					</div>
				</div>
			</div>
			<?php
